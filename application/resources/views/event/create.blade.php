    ...
    <div class="col-md-12">
        <div class="portlet box portlet-theme">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>Tambah Event 
                </div>
                <div class="tools">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('event_description') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('event_description') ? $errors->first('event_description') : 'Masukkan Deskripsi Event Bahasa Indonesia' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('event_description_eng') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('event_description_eng') ? $errors->first('event_description_eng') : 'Masukkan Deskripsi Event Bahasa Inggris' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::label('picture_event', 'Picture', ['class' => 'control-label col-md-2'] ) !!}
                                </div>
                            </div>
                        </div>
...
<script src="{{ assets('pages/scripts/form-dropzone-event.js') }}" type="text/javascript"></script>
@endpush
