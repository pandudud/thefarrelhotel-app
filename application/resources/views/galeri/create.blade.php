        ...
        <div class="portlet box portlet-theme">
            ...
            <div class="portlet-body form">
                <div class="form-horizontal">
                    ...
                    {!! Form::open(['route' => 'galeri.store', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-actions bottom">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'id' => 'submit', 'data-swa-text' => 'Menambahkan Gambar Gallery']) !!}
