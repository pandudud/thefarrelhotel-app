                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('facility_name') ? 'has-error' : ''}}">
                                    {!! Form::label('facility_name', 'Facility Name', ['class' => 'control-label col-md-2'] ) !!}
                                    <div class="col-md-10">
                                        {!! Form::text('facility_name', null, ['class' => 'form-control', 'id' => 'facility_name', 'autofocus'] ) !!}
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('facility_name') ? $errors->first('facility_name') : 'Masukkan Nama Fasilitas' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('facility_description') ? 'has-error' : ''}}">
                                    {!! Form::label('facility_description', 'Facility Description', ['class' => 'control-label col-md-2'] ) !!}
                                    <div class="col-md-10">
                                        {!! Form::textarea('facility_description', null, ['class' => 'form-control', 'id' => 'facility_description', 'autofocus'] ) !!}
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('facility_description') ? $errors->first('facility_description') : 'Masukkan Deskripsi Fasilitas' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions bottom">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Data Fasilitas']) !!}
