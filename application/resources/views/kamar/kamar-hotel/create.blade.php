...
<div class="page-bar margin-bottom-20">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{url('kamar/kamar-hotel')}}">Kamar</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>Tambah</span>
    ...
    <div class="col-md-12">
        <div class="portlet box portlet-theme">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>Tambah Kamar
                </div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <div class="form-horizontal">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('room_description') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('room_description') ? $errors->first('room_description') : 'Masukkan Deskripsi Kamar Bahasa Indonesia' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('room_description_eng') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-control-focus"> </div>
                                        <span class="help-block">{{ $errors->has('room_description_eng') ? $errors->first('room_description_eng') : 'Masukkan Deskripsi Kamar Bahasa Inggris' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('picture_path') ? 'has-error' : ''}}">
