                                ...
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('is_heading') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="md-checkbox" style="margin-top: 5px;">
                                            <input type="checkbox" id="is_heading" name="is_heading" class="md-check" value="1" {{ $errors->any() ? old("is_heading") ? "checked" : "" : "" }} {{count($menu->allchildrens)>0 || $menu->parent_id>0 ? "disabled" : ""}}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('link') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('link', null, ['class' => 'form-control', 'id' => 'link', $menu->is_heading ? 'disabled' : ''] ) !!}
                                        <div class="form-control-focus"> </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('icon') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::text('icon', null, ['class' => 'form-control', 'id' => 'icon', $menu->is_heading ? 'disabled' : ''] ) !!}
                                        <div class="form-control-focus"> </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('parent_id') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::select('parent_id', $parent_id, $menu->parent_id, ['class' => 'form-control select2', 'id' => 'parent_id', $menu->is_heading ? 'disabled' : ''] ) !!}
                                        <div class="form-control-focus"> </div>
                    ...
                    <div class="form-actions bottom">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 ubah', 'type' => 'submit', 'data-swa-text' => 'Mengubah menu']) !!}
